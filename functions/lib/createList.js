...
exports.createInstacartList = createInstacartList;
const firestore_1 = require("firebase-admin/firestore");
const db = (0, firestore_1.getFirestore)();
async function createInstacartList(req, res) {
    try {
        if (req.method !== 'POST') {
        ...
        const ingredientMatchPct = calculateMatchPercentage(consolidatedIngredients, instacartResponse.matchedItems || []);
...
async function createMockInstacartList(ingredients) {
...
function calculateMatchPercentage(allIngredients, matchedItems) {
...
function calculateMockTotalCost(items) {
