          ...
          <div className="max-w-md mx-auto mb-8">
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                />
                {zipError && (
                  <p className="text-red-600 text-sm mt-1 text-left">{zipError}</p>
                )}
              </div>
              <button
                onClick={handleGetStarted}
                disabled={isValidatingZip || zipCode.length !== 5}
                className="px-6 py-3 bg-orange-600 text-white rounded-lg font-semibold hover:bg-orange-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors flex items-center"
              >
                {isValidatingZip ? (
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Paste Your List</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Review & Confirm</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">One-Click Checkout</h3>
              <p className="text-gray-600">
