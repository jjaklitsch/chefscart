...
import { ArrowLeft, ChefHat, Globe } from 'lucide-react'
...
export default function CuisinePage() {
  ...
  const loadCuisineRecipes = async () => {
    try {
      ...
      const matchingCuisine = Array.from(allCuisines).find(cuisine => 
        cuisine.toLowerCase().replace(/[^a-z0-9]+/g, '-') === slug
      )
      ...
      setCuisineName(matchingCuisine)
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-display font-bold mb-6">
              {toTitleCase(cuisineName)} Recipes
            </h1>
            <p className="text-xl md:text-2xl text-orange-100 mb-8 leading-relaxed">
              Discover authentic {cuisineName.toLowerCase()} dishes and bring these incredible flavors to your kitchen.
            </p>
        ...
        {recipes.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-neutral-600 mb-6 max-w-md mx-auto">
              We couldn't find any recipes for this cuisine. Please try browsing other categories.
            </p>
            <Link
              href="/recipes"
