  ...
  return (
    <div
      className={`
        ...
        hover:shadow-medium hover:scale-[1.02] transform h-full flex flex-col
        ${isSelected 
    ...
    >
      ...
      <div className="relative h-48 bg-gradient-to-br from-sage-100 to-cream-100 rounded-t-xl overflow-hidden flex-shrink-0">
        {recipe.imageUrl ? (
          <img 
            src={recipe.imageUrl} 
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <div className="mb-4">
          <h3 className="text-lg font-display font-bold text-neutral-800 mb-2 line-clamp-2 min-h-[3.5rem]">
            {recipe.title}
          </h3>
        ...
        <div className="flex-1 flex flex-col space-y-4">
          ...
          {showNutrition && recipe.nutrition && (
            <div className="grid grid-cols-4 gap-2 p-3 bg-gradient-to-r from-sage-50 to-cream-50 rounded-lg">
